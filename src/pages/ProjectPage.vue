      ...
      <ul class="info-list">
        <li class="wide">
          ...
          <span>
            ...
            ИРНИТУ", базирующемся на платформе MOODLE, данная платформа при всех
            ее достоинствах имеет существенный недостаток в сложности
            регистрации, поэтому необходимо создать страницу с простой
